...
移植新版支持ARM compiler V6 
兼容cubemx初始化

1.所有延时函数用HAL_delay()替换 删掉了正点自己封装的弱智代码 无需包含正点的sys.c / delay.c等垃圾堆

2.修改部分代码 适配F429的FMC

3.修改lcd.h中 Line72 下面的FMC相关参数 适配实验室开发板

4.本文件Line1286 后的代码为原正点原子F407 v3.0工程内lcd_ex.c的代码 为方便移植已经整合

5.背光直接连接了3v3 不用的引脚已经注释（头文件中）
*****************************************************************************************************************
*****************************************************************************************************************
*****************************************************************************************************************
*****************************************************************************************************************
...
{
//    GPIO_InitTypeDef gpio_init_struct;
//    FMC_NORSRAM_TimingTypeDef fsmc_read_handle;
